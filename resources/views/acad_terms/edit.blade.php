                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group ">
                                          ...
                                          <input id="prelims_start_date" name="prelims_start_date" class="form-control" type="text" placeholder="Start Date" value="{{ $acadTerm->getFormattedDate($acadTerm->prelims_start_date) }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input id="prelims_end_date" name="prelims_end_date" class="form-control" type="text" placeholder="End Date" value="{{ $acadTerm->getFormattedDate($acadTerm->prelims_end_date) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group ">
                                            ...
                                            <input id="midterms_start_date" name="midterms_start_date" class="form-control" type="text" placeholder="Start Date" value="{{ $acadTerm->getFormattedDate($acadTerm->midterms_start_date) }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input id="midterms_end_date" name="midterms_end_date" class="form-control" type="text" placeholder="End Date" value="{{ $acadTerm->getFormattedDate($acadTerm->midterms_end_date) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group ">
                                            ...
                                            <input id="finals_start_date" name="finals_start_date" class="form-control" type="text" placeholder="Start Date" value="{{ $acadTerm->getFormattedDate($acadTerm->finals_start_date) }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input id="finals_end_date" name="finals_end_date" class="form-control" type="text" placeholder="End Date" value="{{ $acadTerm->getFormattedDate($acadTerm->finals_end_date) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
