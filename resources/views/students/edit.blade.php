            ...
            <div class="col-xl-12 mb-5 mb-xl-0">
                <div class="card shadow">
                    <div class="card-body">
                      <h2>Edit Student</h2>
                      <hr>
                      <form method="POST" action="{{ action('StudentController@update', $user->id) }}">
                          @csrf
                          @method('PUT')
                          ...
                          <div class="row">
                            <div class="col-12 col-lg-3 col-md-6">
                              ...
                              <input id="date_admitted" name="date_admitted" class="form-control mb-3" type="date" value="{{ $user->student->date_admitted }}" required>
                            </div>
                          </div>
