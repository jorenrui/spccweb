                        ...
                        <form id="form-post" method="POST" action="{{ action('UserController@storeEmployee') }}" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="pl-lg-4 row">
                                <div class="form-group{{ $errors->has('employee_no') ? ' has-danger' : '' }} col-lg-4">
                                    ...
                                    <input type="text" name="employee_no" id="employee_no" class="form-control form-control-alternative{{ $errors->has('employee_no') ? ' is-invalid' : '' }}" placeholder="e.g. K200" value="{{ old('employee_no') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('date_employed') ? ' has-danger' : '' }} col-lg-4">
                                    ...
                                    <input type="date" name="date_employed" id="date_employed" class="form-control form-control-alternative{{ $errors->has('date_employed') ? ' is-invalid' : '' }}" placeholder="e.g. K200" value="{{ old('date_employed') }}" required>
                            ...
                            <div class="pl-lg-4 row">
                                <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }} col col-lg-6">
                                    ...
                                    <input type="password" name="password" id="input-password" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Password" required>
                            ...
                            <div class="pl-lg-4 row">
                                <div class="form-group col col-lg-6">
                                    ...
                                    <input type="password" name="password_confirmation" id="input-password-confirmation" class="form-control form-control-alternative" placeholder="Confirm Password" required>
                                </div>
                            </div>
